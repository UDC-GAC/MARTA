...
#define PRE_LOOP                                     \
  __asm volatile("mov $" TO_STRING(TSTEPS) ", %%ecx" \
                 :                                   \
                 :                                   \
                 : "ecx");
 ...
 */
#define CLOBBER_MEMORY __asm volatile("" \
                                      :  \
                                      :  \
                                      : "memory")
...
#define DO_NOT_TOUCH_IO(var) __asm volatile("" \
                                            : "+"(var)::);
#define DO_NOT_TOUCH_WRITE(var) __asm volatile(""          \
                                               :           \
                                               : "rm"(var) \
                                               : "memory")
#define DO_NOT_TOUCH_READ(var) __asm volatile("" \
                                              : "+r,m"(var))
