...
// [0,0,0,0,0,0,0]
#elif (Y_OPERAND == 1) &&                                                      \
    (((X_IDX_A == X_IDX_B) && (X_IDX_B == X_IDX_C) && (X_IDX_C == X_IDX_D) &&  \
      (X_IDX_D == X_IDX_E) && (X_IDX_E == X_IDX_F) && (X_IDX_F == X_IDX_G) &&  \
      (X_IDX_G == X_IDX_H)) ||                                                 \
     ((X_IDX_A == X_IDX_B) && (X_IDX_C == X_IDX_D) && (X_IDX_E == X_IDX_F) &&  \
      (X_IDX_G == X_IDX_H)) ||                                                 \
     ((X_IDX_A == X_IDX_B) && (X_IDX_B == X_IDX_C) && (X_IDX_C == X_IDX_D) &&  \
      (X_IDX_E == X_IDX_F) && (X_IDX_G == X_IDX_H)) ||                         \
     ((X_IDX_A == X_IDX_B) && (X_IDX_C == X_IDX_D) && (X_IDX_E == X_IDX_F) &&  \
      (X_IDX_G == X_IDX_H)))
#elif (Y_OPERAND == 1) &&                                                      \
    (((X_IDX_A == X_IDX_B) && (X_IDX_B == X_IDX_C) && (X_IDX_C == X_IDX_D)) || \
     ((X_IDX_A == X_IDX_B) && (X_IDX_C == X_IDX_D)) &&                         \
         (X_IDX_E + 1 == X_IDX_F) && (X_IDX_F + 1 == X_IDX_G) &&               \
         (X_IDX_G + 1 == X_IDX_H))
tmp = _mm256_insertf128_ps(tmp, _mm_loadu_ps(&x[X_IDX_E]), 1);
#elif (Y_OPERAND == 1) &&                                                      \
    (((X_IDX_A == X_IDX_B) && (X_IDX_B == X_IDX_C) && (X_IDX_C == X_IDX_D)) || \
     ((X_IDX_A == X_IDX_B) && (X_IDX_C == X_IDX_D)) &&                         \
         (X_IDX_E + 1 == X_IDX_F) && (X_IDX_G + 1 == X_IDX_H))
__m128 ___tmp128;
__m128 ___tmp128l = _mm_loadl_pi(___tmp128, &x[X_IDX_E]);
__m128 ___tmp128h = _mm_loadh_pi(___tmp128l, &x[X_IDX_G]);
tmp = _mm256_insertf128_ps(tmp, ___tmp128h, 1);
#elif (Y_OPERAND == 1) &&                                                      \
    (((X_IDX_A == X_IDX_B) && (X_IDX_B == X_IDX_C) && (X_IDX_C == X_IDX_D)) || \
     ((X_IDX_A == X_IDX_B) && (X_IDX_C == X_IDX_D)))
tmp = _mm256_mask_i32gather_ps(
    ...
    _mm256_set_ps(-1, -1, -1, -1, 0, 0, 0, 0), 4);
#else
// e.g. [0,2,4,6]
...
tmp = _mm256_mask_i32gather_ps(
    ...
    _mm256_set_epi32(X_IDX_H - X_IDX_A, X_IDX_G - X_IDX_A, X_IDX_F - X_IDX_A,
                     X_IDX_E - X_IDX_A, X_IDX_D - X_IDX_A, X_IDX_C - X_IDX_A,
                     X_IDX_B - X_IDX_A, X_IDX_A),
    _mm256_set_ps(0, -1, -1, -1, 0, 0, 0, 0), 4);
#else
tmp = _mm256_mask_i32gather_ps(
    tmp, &x[X_ORIG + X_IDX_A],
    _mm256_set_epi32(X_IDX_H - X_IDX_A, X_IDX_G - X_IDX_A, X_IDX_F - X_IDX_A,
...
// [0,0,0,0,0,0,0]
#elif (Y_OPERAND == 1) &&                                                      \
    (((X_IDX_A == X_IDX_B) && (X_IDX_B == X_IDX_C) && (X_IDX_C == X_IDX_D) &&  \
      (X_IDX_D == X_IDX_E) && (X_IDX_E == X_IDX_F)) ||                         \
     ((X_IDX_A == X_IDX_B) && (X_IDX_C == X_IDX_D) && (X_IDX_E == X_IDX_F)) || \
     ((X_IDX_A == X_IDX_B) && (X_IDX_B == X_IDX_C) && (X_IDX_C == X_IDX_D) &&  \
      (X_IDX_E == X_IDX_F)) ||                                                 \
     ((X_IDX_A == X_IDX_B) && (X_IDX_C == X_IDX_D) && (X_IDX_E == X_IDX_F)))
    ...
    (((X_IDX_A == X_IDX_B) && (X_IDX_B == X_IDX_C) && (X_IDX_C == X_IDX_D)) || \
     ((X_IDX_A == X_IDX_B) && (X_IDX_C == X_IDX_D)) &&                         \
         (X_IDX_E + 1 == X_IDX_F))
__m128 ___tmp128;
__m128 ___tmp128h = _mm_loadl_pi(___tmp128, &x[X_IDX_E]);
tmp = _mm256_insertf128_ps(tmp, ___tmp128h, 1);
#elif (Y_OPERAND == 1) &&                                                      \
    (((X_IDX_A == X_IDX_B) && (X_IDX_B == X_IDX_C) && (X_IDX_C == X_IDX_D)) || \
     ((X_IDX_A == X_IDX_B) && (X_IDX_C == X_IDX_D)))
tmp = _mm256_mask_i32gather_ps(
    ...
    _mm256_set_epi32(X_IDX_H - X_IDX_A, X_IDX_G - X_IDX_A, X_IDX_F - X_IDX_A,
                     X_IDX_E - X_IDX_A, X_IDX_D - X_IDX_A, X_IDX_C - X_IDX_A,
                     X_IDX_B - X_IDX_A, X_IDX_A),
    _mm256_set_ps(0, 0, -1, -1, 0, 0, 0, 0), 4);
#else
tmp = _mm256_mask_i32gather_ps(
    tmp, &x[X_ORIG + X_IDX_A],
    _mm256_set_epi32(X_IDX_H - X_IDX_A, X_IDX_G - X_IDX_A, X_IDX_F - X_IDX_A,
...
// e.g. [0,1,2,3,16,17,18,19]
__m128 aux0;
tmp = _mm256_set_m128(_mm_load_ss(&x[X_ORIG + X_IDX_E]),
                      _mm_loadu_ps(&x[X_ORIG + X_IDX_A]));
#elif (X_IDX_A + 1 == X_IDX_B) && (X_IDX_C + 1 == X_IDX_D)
__m128 aux0, aux1, aux2;
aux0 = _mm_loadl_pi(aux0, &x[X_ORIG + X_IDX_A]);
...
tmp = _mm256_set_m128(aux1, aux0);
#elif (Y_OPERAND == 1) && (((X_IDX_A == X_IDX_B) && (X_IDX_B == X_IDX_C) &&    \
                            (X_IDX_C == X_IDX_D) && (X_IDX_D == X_IDX_E))
#elif (Y_OPERAND == 1) &&                                                      \
    (((X_IDX_A == X_IDX_B) && (X_IDX_B == X_IDX_C) && (X_IDX_C == X_IDX_D)) || \
     ((X_IDX_A == X_IDX_B) && (X_IDX_C == X_IDX_D)))
__m128 ___tmp128l = _mm_load_ss(&x[X_IDX_E]);
tmp = _mm256_insertf128_ps(tmp, ___tmp128l, 1);
#else
tmp = _mm256_mask_i32gather_ps(
    tmp, &x[X_ORIG + X_IDX_A],
    _mm256_set_epi32(X_IDX_H - X_IDX_A, X_IDX_G - X_IDX_A, X_IDX_F - X_IDX_A,
