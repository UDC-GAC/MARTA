...
static inline void kernel(float *restrict p) {
    ...
    _mv_blend_mem_ps(r4,_mm_set_ps(0,0,0,0),p[56],0x00000007);
    _mv_insert_mem_ps(r5,r4,p[66],0x0000005c);
    _mv_insert_mem_ps(r6,r4,p[76],0x0000008c);
    _mv_insert_mem_ps(r7,r6,p[86],0x0000001c);
