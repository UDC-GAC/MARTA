...
static inline void kernel(float *restrict p) {
    ...
    __m256 output;
    _mv_blend_mem_ps(r0,_mm_set_epi32(0,0,0,0),p[16],0x0000000b);
    _mv_insert_mem_ps(r1,r0,p[26],0x0000001c);
    _mv_insert_mem_ps(r2,r1,p[36],0x000000e8);
    _mv_insert_mem_ps(r3,r2,p[46],0x00000030);
    _mv_blend_mem_ps(r4,_mm_set_epi32(0,0,0,0),p[56],0x00000007);
    _mv_blend_mem_ps(r5,r4,p[65],0x00000006);
