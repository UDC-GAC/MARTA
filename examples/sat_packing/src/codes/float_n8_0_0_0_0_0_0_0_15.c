...
static inline void kernel(float *restrict p) {
    ...
    _mv_insert_mem_ps(r2,r0,p[36],0x00000042);
    _mv_insert_mem_ps(r3,r2,p[46],0x00000010);
    r4 = _mm_movelh_ps(r1,r3);
    _mv_blend_mem_ps(r5,_mm_set_ps(0,0,0,0),p[56],0x0000000d);
    _mv_insert_mem_ps(r6,r5,p[66],0x00000094);
    _mv_insert_mem_ps(r7,r5,p[76],0x0000000a);
    _mv_insert_mem_ps(r8,r7,p[86],0x00000058);
