...
static inline void kernel(float *restrict p) {
    // [0, 67, 57, 47, 46, 36, 26, 16] [0, 0, 1, 0, 0, 0] (float)
    ...
    _mv_insert_mem_ps(r3,r2,p[46],0x00000054);
    r4 = _mm_movelh_ps(r1,r3);
    _mv_blend_mem_ps(r5,_mm_set_epi32(0,0,0,0),p[47],0x0000000d);
    _mv_insert_mem_ps(r6,r5,p[57],0x00000018);
    _mv_insert_mem_ps(r7,r6,p[67],0x00000028);
